...
@if(App::getLocale() == 'ar')
	...
	<table style="font-family: arial, sans-serif; border-collapse: collapse; width: 50%; color: black !important;" class="left">
		...
		<tr style="background-color: #ffffff;">
			...
			<td style="border: 1px solid #ffffff; text-align: left; padding: 1px; vertical-align:top; font-size: 12px !important;">Customer Address</td>
		</tr>
		@endif
		...
		@if(!empty($receipt_details->customer_custom_fields))
		<tr style="background-color: #ffffff;">
			<td style="border: 1px solid #ffffff; text-align: right; padding: 1px; vertical-align:top; font-size: 12px !important;">رقم السجل التجتري</td>
				...
				@foreach($receipt_details->lines as $line)
					...
					{{-- 		@if($receipt_details->show_cat_code == 1)
							...
							@if(!empty($line['modifiers']))
								@foreach($line['modifiers'] as $modifier)
								 <!--- Dev Changed -->
								<td style="border: 1px solid black; border-collapse: collapse;" valign="top" class="text-right">
										{{$line['unit_price_exc_tax']}}  <br> {{number_format($modifier['unit_price_exc_tax'],2)}}							
								</td>
									{{-- @php
										$total_unit_price += $line['unit_price_exc_tax'] + $modifier['unit_price_exc_tax'];
							...
							@else
								<td style="border: 1px solid black; border-collapse: collapse;" valign="top" class="text-right">
									{{-- {{$line['unit_price_exc_tax']}} --}} {{$line['unit_price_exc_tax']}}
								</td>
							@endif
							...
							@else
								<td style="border: 1px solid black; border-collapse: collapse;" valign="top" class="text-center">
									{{number_format($line['quantity'], 0)}} <small>{{$line['units']}}</small>
								</td>
							@endif
							...
							<td style="border: 1px solid black; border-collapse: collapse;" valign="top" class="text-right">
								{{-- {{$line['line_discount_uf'] }}  --}}{{number_format($line['line_discount_uf'], 2)}}
							</td>
							@if(!empty($line['modifiers']))
								@foreach($line['modifiers'] as $modifier)
									<!-- - Dev Changed -->
									<td style="border: 1px solid black; border-collapse: collapse;" valign="top" class="text-right">
										{{isset($line['tax']) ? $line['tax']: 0}} <br> {{isset($modifier['tax']) ? $modifier['tax']: 0}}
									</td>	
								@endforeach
							@else
								<!-- - Dev Changed -->
								<td style="border: 1px solid black; border-collapse: collapse;" valign="top" class="text-right">
									{{-- {{isset($line['tax']) ? $line['tax']: 0}}  --}}{{isset($line['tax']) ? $line['tax']: 0}}
								</td>
							@endif
							<td style="border: 1px solid black; border-collapse: collapse;" valign="top" class="text-right">
								{{-- {{$line['line_total']}} --}} {{number_format($line['line_total'], 2)}}
							</td>
...
@if(App::getLocale() == 'ar')
	<div class="row invoice-info color-555" style="page-break-inside: avoid !important">
		...
		<!-- Total Items -->
		<tr style="background-color: #ffffff;">
			<td style="border: 1px solid #ffffff; text-align: right; padding: 1px; vertical-align:top; font-size: 12px !important;">  عدد الاصناف </td>
			...
			<td style="border: 1px solid #ffffff; text-align: left; padding: 1px; vertical-align:top; font-size: 12px !important;">Returned Items					
			</td>
		</tr>  

		<!-- Total Quantity -->
		<tr style="background-color: #ffffff;">
			<td style="border: 1px solid #ffffff; text-align: right; padding: 1px; vertical-align:top; font-size: 12px !important;">  الكمية المرتجعة </td>
			...
			<td style="border: 1px solid #ffffff; text-align: left; padding: 1px; vertical-align:top; font-size: 12px !important;">Returned Quantity					
			</td>

		<!-- SubTotal without Tax -->
		<tr style="background-color: #ffffff;">
			<td style="border: 1px solid #ffffff; text-align: right; padding: 1px; vertical-align:top; font-size: 12px !important;"> الإجمالي قبل الضريبة </td>
			...
			<td style="border: 1px solid #ffffff; text-align: left; padding: 1px; vertical-align:top; font-size: 12px !important;">Returned Amount (Before VAT)
			</td>
		</tr> 
		...
		<!-- Total Tax -->
		<tr style="background-color: #ffffff;">
			<td style="border: 1px solid #ffffff; text-align: right; padding: 1px; vertical-align:top; font-size: 12px !important;">  مبلغ الضريبة (+)</td>
			...
			<td style="border: 1px solid #ffffff; text-align: left; padding: 1px; vertical-align:top; font-size: 12px !important;"> (+) Returned VAT 
			</td>
		</tr> 

		<!-- SubTotal -->
		<tr style="background-color: #ffffff;">
			<td style="border: 1px solid #ffffff; text-align: right; padding: 1px; vertical-align:top; font-size: 12px !important;">  مبلغ فاتورة المرتجع </td>
			...
			<td style="border: 1px solid #ffffff; text-align: left; padding: 1px; vertical-align:top; font-size: 12px !important;">Return Subtotal						
			</td>
		</tr>
		...
		<tr style="background-color: #ffffff;">
			<td style="border: 1px solid #ffffff; text-align: right; padding: 1px; vertical-align:top; font-size: 12px !important;">   مبلغ الخصم  (-)</td>
			...
			<td style="border: 1px solid #ffffff; text-align: left; padding: 1px; vertical-align:top; font-size: 12px !important;"> (-) Return {!! $receipt_details->discount_label !!}						
			</td>
		</tr>  
		@endif
		...
		<!-- Total -->
		<tr style="background-color: #ffffff;">
			<td style="border: 1px solid #ffffff; text-align: right; padding: 1px; vertical-align:top; font-size: 12px !important;">إجمالي مبلغ المرتجع</td>
			...
			<td style="border: 1px solid #ffffff; text-align: left; padding: 1px; vertical-align:top; font-size: 12px !important;">Total Retuned Amount
			</td>
		</tr>  
...
@else
	<div class="row invoice-info color-555" style="page-break-inside: avoid !important">
		...
		<!-- SubTotal without Tax -->
		<tr style="background-color: #ffffff;">
			<td style="border: 1px solid #ffffff; text-align: left; padding: 1px; vertical-align:top; font-size: 12px !important;">Returned Amount (Before VATt)</td>
			<td style="border: 1px solid #ffffff; text-align: center; padding: 1px; vertical-align:top; font-size: 12px !important;"><span class="display_currency" data-currency_symbol="false";>{{isset($receipt_details->price_exc_tax_total) ? $receipt_details->price_exc_tax_total: 0}} </span></td>
