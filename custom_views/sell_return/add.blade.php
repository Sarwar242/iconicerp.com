...
<script type="text/javascript">
	...
	function update_sell_return_total(){
		...
		$('table#sell_return_table tbody tr').each( function(){
			...
			$(this).find('.return_tax').text(__currency_trans_from_en(return_tax, true));
			$(this).find('.return_subtotal').text(__currency_trans_from_en(subtotal, true));
			net_return += subtotal;
			total_tax += return_tax;
		});
		var discount = 0;
		...
		// var total_tax = __calculate_amount('percent', tax_percent, discounted_net_return);
