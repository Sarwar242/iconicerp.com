...
@php
	$modifier_item_total_exc_tax = 0 ; 
@endphp

@php
	$modifier_item_value = 0 ; 
@endphp
		...
		<table style="width:100%; border: 1px solid black; border-collapse: collapse">
			...
			@foreach($line['modifiers'] as $modifier)
                        ...
                        <td style="border: 1px solid black; border-collapse: collapse;" class="text-right" valign="top">
							{{$line['unit_price_before_discount']}} </br>  {{$modifier['unit_price_exc_tax']}}
                                                       ...
                                                       @php
	                                                $modifier_item_value += $line['unit_price_before_discount'] ; 
                                                       @endphp
						</td>
                        @endforeach
                        @else
			...
			@foreach($line['modifiers'] as $modifier)
						...
						<td style="border: 1px solid black; border-collapse: collapse;" class="text-right" valign="top">
                          ...
                          @php
	                   $modifier_item_total_exc_tax = ( $modifier_item_value + $modifier['unit_price_exc_tax'] )
                          @endphp

                          @php
	                   $modifier_item_total_exc_tax2 = ( $modifier_item_total_exc_tax * $line['quantity'] )
                          @endphp
                          
                        <td style="border: 1px solid black; border-collapse: collapse;" class="text-right" valign="top">
							<span class="display_currency" data-currency_symbol="false">
								{{-- {{$line['price_exc_tax']}} --}} </br> {{ $modifier_item_total_exc_tax2 }}
							</span>
							@php
