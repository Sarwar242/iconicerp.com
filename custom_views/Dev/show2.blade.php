    ...
    <div class="col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
      <table class="table">
        <tr>
          ...
          <td></td>
          <td class="pull-right">{{@format_quantity($new_data['total_returned_items'])}} {{$unit_name}}</td>
        </tr>
        <tr>
          <th>Total Returned Quantity</th>
          <td></td>
          <td class="pull-right">{{@format_quantity($new_data['total_returned_quantity'])}} {{$unit_name}}</td>
        </tr>
        <tr>
          <th>Total Returned Amount (Without Tax)</th>
          <td></td>
          <td class="pull-right">{{@format_quantity($new_data['total_returned_without_tax'])}} {{$unit_name}}</td>
        </tr>
        ...
        <tr>
          ...
          <td></td>
          <td><span class="display_currency pull-right" data-currency_symbol="true">{{ $total_before_tax - $total_discount }}</span></td>
        </tr>
      </table>
    </div>
  </div>
