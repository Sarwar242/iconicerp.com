    ...
    public function calculateInvoiceTotal($products, $tax_id, $discount = null, $uf_number = true)
    {
        ...
        foreach ($products as $product) {
          ...
          //<!--- Dev Changed -->
            ...
            $output['tax'] += isset($product['unit_tax'])?($product['unit_tax'] * $product['quantity']):0 ;
            \Log::warning("unit tax: ". $output['tax']);
        ...
        // \Log::warning("Final total1: ".$output['total_before_tax']  );
        //Calculate discount
        ...
        //     }
        // }
        \Log::warning("output tax: ". $output['tax']);
        //<!--- Dev Changed -->
        //Calculate total
