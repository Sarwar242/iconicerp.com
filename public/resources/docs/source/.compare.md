...
[Get Postman Collection](https://testpos.iconicerp.com/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "https://testpos.iconicerp.com/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"facilis","ip_address":"quidem","latitude":"soluta","longitude":"vitae"}'
...
```bash
curl -X POST \
    "https://testpos.iconicerp.com/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"voluptatem","latitude":"qui","longitude":"reiciendis"}'
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/holidays?location_id=sed&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=aliquam&follow_up_type=dolores&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "https://testpos.iconicerp.com/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"in","schedule_type":"velit","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=pariatur&biz_name=cupiditate&mobile_num=6&contact_id=aspernatur&order_by=magnam&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "https://testpos.iconicerp.com/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"reprehenderit","mobile_name":"labore","call_type":"call","start_time":"cupiditate","end_time":"sapiente","duration":"rerum"}]}'
...
let body = {
    "call_logs": [
        {
            "mobile_number": "reprehenderit",
            "mobile_name": "labore",
            "call_type": "call",
            "start_time": "cupiditate",
            "end_time": "sapiente",
            "duration": "rerum"
        }
    ]
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=deserunt&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":15,"initial_amount":86908891.33153545856475830078125,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":703910.069999999948777258396148681640625,"total_card_slips":1,"total_cheques":14,"closing_note":"inventore","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 15,
    "initial_amount": 86908891.33153545856475830078125,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 703910.069999999948777258396148681640625,
    "total_card_slips": 1,
    "total_cheques": 14,
    "closing_note": "inventore",
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/contactapi?type=nesciunt&name=qui&biz_name=dolorum&mobile_num=8&contact_id=omnis&order_by=cum&direction=necessitatibus&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"omnis","prefix":"consequuntur","first_name":"qui","middle_name":"in","last_name":"dolorum","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"dignissimos","address_line_2":"id","city":"aut","state":"odio","country":"saepe","zip_code":"non","customer_group_id":"et","contact_id":"tempore","dob":"2000-06-13","custom_field1":"sit","custom_field2":"labore","custom_field3":"beatae","custom_field4":"et","email":"ea","shipping_address":"qui","position":"velit","opening_balance":0,"source_id":17,"life_stage_id":8,"assigned_to":[]}'
...
let body = {
    ...
    "dob": "2000-06-13",
    "custom_field1": "sit",
    "custom_field2": "labore",
    "custom_field3": "beatae",
    "custom_field4": "et",
    "email": "ea",
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"enim","prefix":"expedita","first_name":"ab","middle_name":"qui","last_name":"cum","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"sunt","address_line_2":"qui","city":"quaerat","state":"perspiciatis","country":"odio","zip_code":"quis","customer_group_id":"dolorum","contact_id":"perspiciatis","dob":"2000-06-13","custom_field1":"est","custom_field2":"vel","custom_field3":"et","custom_field4":"pariatur","email":"voluptas","shipping_address":"expedita","position":"dolor","opening_balance":10.300000000000000710542735760100185871124267578125,"source_id":18,"life_stage_id":1,"assigned_to":[]}'
...
let body = {
    ...
    "country": "odio",
    "zip_code": "quis",
    "customer_group_id": "dolorum",
    "contact_id": "perspiciatis",
    "dob": "2000-06-13",
    "custom_field1": "est",
    "custom_field2": "vel",
    "custom_field3": "et",
...
```bash
curl -X POST \
    "https://testpos.iconicerp.com/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":13,"card_number":"quisquam","card_holder_name":"commodi","card_transaction_number":"voluptatem","card_type":"et","card_month":"ut","card_year":"laboriosam","card_security":"perferendis","transaction_no_1":"minus","transaction_no_2":"aut","transaction_no_3":"quod","cheque_number":"est","bank_account_number":"ut","note":"porro"}'
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/expense?location_id=enim&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=nam&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":4753.899999999999636202119290828704833984375,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":13,"expense_for":20,"contact_id":10,"additional_notes":"dolore","is_refund":0,"is_recurring":0,"recur_interval":4,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"ullam","recur_repetitions":10,"payment":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":10,"card_number":"nulla","card_holder_name":"deleniti","card_transaction_number":"quaerat","card_type":"libero","card_month":"doloremque","card_year":"aliquam","card_security":"rerum","transaction_no_1":"dolorem","transaction_no_2":"est","transaction_no_3":"sapiente","note":"impedit","cheque_number":"itaque"}]}'
...
let body = {
    "location_id": 1,
    "final_total": 4753.899999999999636202119290828704833984375,
    ...
    "payment": [
        {
            ...
            "account_id": 10,
            "card_number": "nulla",
            "card_holder_name": "deleniti",
            "card_transaction_number": "quaerat",
            "card_type": "libero",
            "card_month": "doloremque",
            "card_year": "aliquam",
            "card_security": "rerum",
            "transaction_no_1": "dolorem",
            "transaction_no_2": "est",
            "transaction_no_3": "sapiente",
            "note": "impedit",
            "cheque_number": "itaque"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://testpos.iconicerp.com/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":1293.279999999999972715158946812152862548828125,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":8,"expense_for":6,"contact_id":18,"additional_notes":"numquam","is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"voluptas","recur_repetitions":12,"payment":[]}'
...
let body = {
    "final_total": 1293.279999999999972715158946812152862548828125,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 8,
    "expense_for": 6,
    "contact_id": 18,
    "additional_notes": "numquam",
    "is_recurring": 0,
    "recur_interval": 3,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/expense-refund?location_id=voluptates&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=eos&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/product?order_by=minus&order_direction=praesentium&brand_id=ut&category_id=aut&sub_category_id=est&location_id=et&selling_price_group=et&name=est&sku=harum&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/product"
);

let params = {
    "order_by": "minus",
    "order_direction": "praesentium",
    "brand_id": "ut",
    "category_id": "aut",
    "sub_category_id": "est",
    "location_id": "et",
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/product/1?selling_price_group=rerum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/product/1"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/variation/2?product_id=molestiae&location_id=minus&brand_id=eveniet&category_id=sit&sub_category_id=commodi&not_for_selling=dolore&name=modi&sku=ut&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/sell?location_id=non&contact_id=minima&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=fugit&service_staff_id=laborum&shipping_status=ordered&only_subscriptions=iste&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "fugit",
    "service_staff_id": "laborum",
    "shipping_status": "ordered",
    "only_subscriptions": "iste",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":12,"contact_id":1,"transaction_date":"2020-07-22 15:48:29","invoice_no":"nihil","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":16,"discount_amount":10,"discount_type":"fixed","sale_note":"voluptates","staff_note":"velit","commission_agent":6,"shipping_details":"Express Delivery","shipping_address":"dolorem","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":8,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":18,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"quod","recur_repetitions":14,"rp_redeemed":6,"rp_redeemed_amount":13.5,"types_of_service_id":17,"service_custom_field_1":"omnis","service_custom_field_2":"nobis","service_custom_field_3":"natus","service_custom_field_4":"illo","service_custom_field_5":"commodi","service_custom_field_6":"rerum","round_off_amount":30535.139999999999417923390865325927734375,"table_id":3,"service_staff_id":17,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":19,"note":"molestias"}],"payments":[{"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":4,"card_number":"incidunt","card_holder_name":"consequuntur","card_transaction_number":"amet","card_type":"animi","card_month":"quibusdam","card_year":"saepe","card_security":"laboriosam","transaction_no_1":"hic","transaction_no_2":"id","transaction_no_3":"reiciendis","bank_account_number":"doloremque","note":"est","cheque_number":"facilis"}]}]}'
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://testpos.iconicerp.com/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":5,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":3,"discount_amount":10,"discount_type":"fixed","sale_note":"rerum","staff_note":"consequatur","sells":[{"is_suspend":false}],"commission_agent":11,"shipping_details":"Express Delivery","shipping_address":"libero","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":13,"pay_term_number":15,"pay_term_type":"months","is_recurring":0,"recur_interval":2,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"animi","recur_repetitions":4,"rp_redeemed":15,"rp_redeemed_amount":13.5,"types_of_service_id":2,"service_custom_field_1":"laudantium","service_custom_field_2":"dicta","service_custom_field_3":"autem","service_custom_field_4":"repellendus","service_custom_field_5":"eveniet","service_custom_field_6":"sint","round_off_amount":2072598.68549999990500509738922119140625,"table_id":6,"service_staff_id":17,"change_return":0,"change_return_id":13,"products":[{"sell_line_id":13,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":7,"discount_amount":0,"discount_type":"percentage","sub_unit_id":15,"note":"quod"}],"payments":[{"payment_id":13,"amount":453.1299999999999954525264911353588104248046875,"method":"cash","account_id":1,"card_number":"corrupti","card_holder_name":"veritatis","card_transaction_number":"voluptatem","card_type":"sed","card_month":"quos","card_year":"error","card_security":"maiores","transaction_no_1":"praesentium","transaction_no_2":"cupiditate","transaction_no_3":"sequi","note":"molestias","cheque_number":"itaque","bank_account_number":"rerum"}]}'
...
let body = {
    ...
    "service_custom_field_1": "laudantium",
    "service_custom_field_2": "dicta",
    "service_custom_field_3": "autem",
    "service_custom_field_4": "repellendus",
    "service_custom_field_5": "eveniet",
    "service_custom_field_6": "sint",
    "round_off_amount": 2072598.68549999990500509738922119140625,
    "table_id": 6,
    "service_staff_id": 17,
    "change_return": 0,
    "change_return_id": 13,
    ...
    "payments": [
        {
            ...
            "method": "cash",
            "account_id": 1,
            "card_number": "corrupti",
            "card_holder_name": "veritatis",
            "card_transaction_number": "voluptatem",
            "card_type": "sed",
            "card_month": "quos",
            "card_year": "error",
...
```bash
curl -X DELETE \
    "https://testpos.iconicerp.com/public/connector/api/sell/corrupti" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://testpos.iconicerp.com/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":2,"transaction_date":"2020-5-7 15:20:22","invoice_no":"deserunt","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":3,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://testpos.iconicerp.com/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":11,"shipping_status":"ordered","delivered_to":"est"}'
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/table?location_id=sunt" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/taxonomy?type=quo" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "https://testpos.iconicerp.com/public/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"omnis","first_name":"voluptas","last_name":"eos","email":"itaque","is_active":"reiciendis","user_type":"quae","crm_contact_id":12,"allow_login":false,"username":"dolorem","password":"ut","role":14,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"corrupti","max_sales_discount_percent":"aspernatur","selected_contacts":true,"selected_contact_ids":[],"dob":"totam","gender":"natus","marital_status":"cum","blood_group":"rem","contact_number":"omnis","alt_number":"sed","family_number":"veniam","fb_link":"tenetur","twitter_link":"eum","social_media_1":"autem","social_media_2":"in","custom_field_1":"vel","custom_field_2":"quisquam","custom_field_3":"eveniet","custom_field_4":"sint","guardian_name":"unde","id_proof_name":"sed","id_proof_number":"voluptatibus","permanent_address":"corporis","current_address":"esse","bank_details":[{"account_holder_name":"temporibus","account_number":"impedit","bank_name":"perspiciatis","bank_code":"praesentium","branch":"quam","tax_payer_id":"deleniti"}]}'
...
let body = {
    ...
    "cmmsn_percent": "corrupti",
    "max_sales_discount_percent": "aspernatur",
    ...
    "marital_status": "cum",
    "blood_group": "rem",
    "contact_number": "omnis",
    "alt_number": "sed",
    "family_number": "veniam",
    "fb_link": "tenetur",
    "twitter_link": "eum",
    "social_media_1": "autem",
    "social_media_2": "in",
    "custom_field_1": "vel",
    "custom_field_2": "quisquam",
    "custom_field_3": "eveniet",
    "custom_field_4": "sint",
    "guardian_name": "unde",
    "id_proof_name": "sed",
    "id_proof_number": "voluptatibus",
    "permanent_address": "corporis",
    "current_address": "esse",
    "bank_details": [
        {
            "account_holder_name": "temporibus",
            "account_number": "impedit",
            "bank_name": "perspiciatis",
            "bank_code": "praesentium",
            "branch": "quam",
            "tax_payer_id": "deleniti"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/user?service_staff=dolorem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/user"
);

let params = {
    "service_staff": "dolorem",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://testpos.iconicerp.com/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"corporis","new_password":"in"}'
...
```bash
curl -X POST \
    "https://testpos.iconicerp.com/public/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"quibusdam"}'
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/profit-loss-report?location_id=quis&start_date=2018-06-25&end_date=2018-06-25&user_id=excepturi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://testpos.iconicerp.com/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://testpos.iconicerp.com/public/connector/api/notifications"
);
